...
add_additional_information(explain_titanic_glm$data, titanic_glm_ai, aspects)
```
...
```{r}
BostonHousing2_ai_add <- add_additional_information(data, BostonHousing2_ai, aspects_list, show_cor = T)
