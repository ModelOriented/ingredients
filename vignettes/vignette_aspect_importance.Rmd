...
titanic_glm_ai
plot(titanic_glm_ai) + ggtitle("Aspect importance for the selected passenger (logistic regression)")
```
...
titanic_rf_ai
plot(titanic_rf_ai) + ggtitle("Aspect importance for the selected passenger (random forest)")
```
