...
titanic_glm_ai <- aspect_importance(explain_titanic_glm, passenger, aspects, N)
titanic_glm_ai
...
On `BostonHousing2` dataset, we will test the function that automatically groups features (grouping is based on the features correlation). Function only works on numeric variables.  
