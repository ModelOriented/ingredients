...
```{r}
pp_age  <- partial_profiles(explain_titanic_rf, variables =  c("age", "fare"))
head(pp_age)
plot(pp_age)
```
...
```{r}
cp_age  <- conditional_profiles(explain_titanic_rf, variables =  c("age", "fare"))
plot(cp_age)
```
...
```{r}
ap_age  <- accumulated_profiles(explain_titanic_rf, variables =  c("age", "fare"))
plot(ap_age)
```
