...
Aspect importance method takes on the challenge of interpreting model built on highly dimensional data. There exists a number of methods for local explanation of black-box models, like Break Down, Shap or LIME. However, the problem arise when the explanatory variables are correlated. 
